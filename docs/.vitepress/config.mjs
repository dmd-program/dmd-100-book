...
const config = {
  ...
  exportPdf: {
    ...
    styles: [
      ...
      '.VPNav, .VPSidebar, .edit-link { display: none !important; }',
    ...
    pdfOptions: {
      ...
      headerTemplate: '<div style="font-size:10px; width:100%; text-align:center;">DMD 100: Digital Multimedia Design Foundations</div>',
    ...
    generatePdf: true,
    outputPath: 'dmd-100-complete-book.pdf'
  },
  ...
  themeConfig: {
    ...
    showPageLicense: false,
    showSitewideLicense: true,
